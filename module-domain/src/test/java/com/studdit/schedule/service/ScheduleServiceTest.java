...
class ScheduleServiceTest {
    ...
    void createSchedule() {
        ...
        assertThat(response.getStartDateTime()).isEqualTo(savedSchedule.getStartDateTime());
        assertThat(response.getEndDateTime()).isEqualTo(savedSchedule.getEndDateTime());
